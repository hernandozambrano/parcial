$(document).ready(function () {
    $('#tablaRedesSociales').DataTable({
        "ajax": {
            "url": "/PaginaHZ/controller/social_media.php?op=listar", // Ruta al controlador PHP
            "type": "GET",
            "dataSrc": ""
        },
        "dom": 'Bfrtip',
...
function eliminarSocialMedia(socmed_id) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.post('/PaginaHZ/controller/social_media.php?op=eliminar', 
                { id: socmed_id }, 
                function(response) {
                    if (response === 'success') {
                        Swal.fire(
...
function cargarDatosModal(socmed_id) {
    ...
    $.post('/PaginaHZ/controller/social_media.php?op=mostrar', 
        { socmed_id: socmed_id }, 
        function(response) {
...
function guardarSocialMedia() {
    ...
    $.post(`/PaginaHZ/controller/social_media.php?op=${operacion}`, 
        { 
            socmed_id: socmed_id, 
