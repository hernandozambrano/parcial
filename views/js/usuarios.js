$(document).ready(function () {
  $('#tablaUsuarios').DataTable({
      "ajax": {
          "url": "/PaginaHZ/controller/usuarios.php?op=listar",
          "type": "GET",
          "dataSrc": ""
      },
      "columns": [
...
function guardarUsuario() {
  ...
  $.post(`/PaginaHZ/controller/usuarios.php?op=${operacion}`, { id, nombre, apep, apem, correo, telf, pass, estado }, function (response) {
...
function cargarDatosModal(id) {
  $.post('/PaginaHZ/controller/usuarios.php?op=mostrar', { id }, function (response) {
...
function eliminarUsuario(id) {
  Swal.fire({
      ...
      if (result.isConfirmed) {
          $.post('/PaginaHZ/controller/usuarios.php?op=eliminar', { id }, function (response) {
              if (response === 'success') {
